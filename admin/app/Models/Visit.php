 ...
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Visit whereCheckinAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Visit whereCheckinGateId($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Visit whereCheckoutAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Visit whereCheckoutGateId($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Visit whereCreatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Visit whereCurrentPosition($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Visit whereDestinationName($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Visit whereId($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Visit whereIdentityPhoto($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Visit wherePurposeOfVisit($value)
